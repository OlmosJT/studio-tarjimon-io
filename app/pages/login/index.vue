...
// 2. Handle Google Login (Simulated)
// In a real app, this function runs after the Google Popup returns an 'credential' (ID Token)
function triggerGoogleSignIn() {
  // Simulate getting a token from Google SDK
  const mockGoogleIdToken = "google-id-token-sample";
  loginWithGoogle(mockGoogleIdToken);
}
</script>
...
<template>
  <div>
    ...
    <div class="mt-6 text-center text-sm">
      ...
      <a href="#" class="font-medium text-black hover:underline ml-1">Sign up</a>
    </div>
